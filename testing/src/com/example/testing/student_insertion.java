    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //    Connection ck,c1,c2,c3;
            ...
            {   
              ...
              ck.close();
              Connection  ck1=DriverManager.getConnection("jdbc:google:mysql://pr-server:project-server/m_project?user=root");
              ...
              Statement sk=ck1.createStatement();
                ...
                if(check)
                {
                  ...
                  ck1.close();
                  Connection  ck2=DriverManager.getConnection("jdbc:google:mysql://pr-server:project-server/m_project?user=root");
            ...
            {   
                Class.forName("com.mysql.jdbc.GoogleDriver");
               Connection c1=DriverManager.getConnection("jdbc:google:mysql://pr-server:project-server/m_project?user=root");
            ...
            {   
                Class.forName("com.mysql.jdbc.GoogleDriver");
              Connection  c2=DriverManager.getConnection("jdbc:google:mysql://pr-server:project-server/m_project?user=root");
            ...
            //    response.setHeader("me done",aa);
              ...
              {   
                  Class.forName("com.mysql.jdbc.GoogleDriver");
                 Connection c4=DriverManager.getConnection("jdbc:google:mysql://pr-server:project-server/m_project?user=root");
              ...
              {   
                  Class.forName("com.mysql.jdbc.GoogleDriver");
                 Connection c5=DriverManager.getConnection("jdbc:google:mysql://pr-server:project-server/m_project?user=root");
            ...
            {   
                Class.forName("com.mysql.jdbc.GoogleDriver");
               Connection c3=DriverManager.getConnection("jdbc:google:mysql://pr-server:project-server/m_project?user=root");
